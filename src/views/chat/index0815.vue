...
import { fetchChatAPIProcess, fetchImageAPIProcess } from '@/api'
 ...
 * @return {*}
 */
async function onimageConversation() {
  ...
  let options: Chat.ImageConversationRequest = {}
  ...
  try {
    ...
    const fetchChatAPIOnce = async () => {
      await fetchImageAPIProcess<Chat.ImageConversationResponse>({
        prompt: message,
        options,
    ...
    <footer :class="footerClass">
      <div class="w-full max-w-screen-xl m-auto">
        <div class="flex items-center justify-between space-x-2">
          ...
          <!-- <NButton type="info" :disabled="buttonDisabled" @click="handleImageSubmit">
            <template #icon>
              <span class="dark:text-black">
